...
public class EnvCredentialProvider implements ICredentialProvider {
    ...
    private static final String AK_ENV_NAME = "TMCLOUD_SDK_AK";
    private static final String SK_ENV_NAME = "TMCLOUD_SDK_SK";
    private static final String PROJECT_ID_ENV_NAME = "TMCLOUD_SDK_PROJECT_ID";
    private static final String DOMAIN_ID_ENV_NAME = "TMCLOUD_SDK_DOMAIN_ID";
    private static final String SECURITY_TOKEN_ENV_NAME = "TMCLOUD_SDK_SECURITY_TOKEN";
    private static final String IDP_ID_ENV_NAME = "TMCLOUD_SDK_IDP_ID";
    private static final String ID_TOKEN_FILE_ENV_NAME = "TMCLOUD_SDK_ID_TOKEN_FILE";
