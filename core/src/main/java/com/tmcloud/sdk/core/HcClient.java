...
import com.tmcloud.sdk.core.auth.ICredential;
import com.tmcloud.sdk.core.exception.DefaultExceptionHandler;
import com.tmcloud.sdk.core.exception.ExceptionHandler;
import com.tmcloud.sdk.core.exception.HostUnreachableException;
import com.tmcloud.sdk.core.exception.SdkException;
import com.tmcloud.sdk.core.exception.ServerResponseException;
import com.tmcloud.sdk.core.exception.ServiceResponseException;
import com.tmcloud.sdk.core.exchange.ApiReference;
import com.tmcloud.sdk.core.exchange.SdkExchange;
import com.tmcloud.sdk.core.exchange.SdkExchangeCache;
import com.tmcloud.sdk.core.http.Field;
...
import com.tmcloud.sdk.core.http.SdkFormDataBody;
import com.tmcloud.sdk.core.impl.DefaultHttpClient;
import com.tmcloud.sdk.core.progress.ProgressInputStream;
import com.tmcloud.sdk.core.progress.ProgressRequest;
import com.tmcloud.sdk.core.progress.SimpleProgressManager;
import com.tmcloud.sdk.core.utils.CastUtils;
import com.tmcloud.sdk.core.utils.ExceptionUtils;
import com.tmcloud.sdk.core.utils.HttpUtils;
...
import static com.tmcloud.sdk.core.Constants.SDK_EXCHANGE;
...
public class HcClient implements CustomizationConfigure {
    ...
    public static class AccessLog {
        private static final Logger logger = LoggerFactory.getLogger("TMCloud-SDK-Access");
    ...
    protected <R, S> HttpRequest buildRequest(R request, HttpRequestDef<R, S> reqDef) {
        ...
        httpRequestBuilder.addHeader(Constants.USER_AGENT, "tmcloud-usdk-java/3.0");
